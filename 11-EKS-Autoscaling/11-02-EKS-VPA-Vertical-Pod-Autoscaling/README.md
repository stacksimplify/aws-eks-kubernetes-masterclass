...
- Make a note of resources. We donly define `spec.containers.resources.requests`.
...
## Step-09: Clean-Up
```
kubectl delete -f 01-kubenginx-Deployment-NodePort-Service.yml -f 02-kubenginx-VPA-manifest.yml
```