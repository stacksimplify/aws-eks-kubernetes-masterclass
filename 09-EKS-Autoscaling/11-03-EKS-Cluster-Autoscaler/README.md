...
eksctl create cluster --name=appmesh \
                      ...
                      --alb-ingress-access 
```                      
### **Example-2:** Create Cluster and later create nodegroup separately
```
# Create Cluster
...
- You should see a inline policy named `eksctl-eksdemo1-nodegroup-eksdemo1-ng-public1-PolicyAutoScaling` in the list of policies associated to this role.
...
```
# Deploy Application
kubectl apply -f 01-kubenginx-Deployment-Service.yml
```
...
```
kubectl delete -f 01-kubenginx-Deployment-Service.yml
```
